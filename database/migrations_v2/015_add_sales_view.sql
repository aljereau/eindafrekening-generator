-- Migration: 015_add_sales_view.sql
-- Created: 2026-01-21
-- Description: Comprehensive Sales View - all property info useful for sales

-- ============================================
-- v_sales
-- Robust view for Sales team with:
--   - Property details (huizen)
--   - Owner details (eigenaar via inhuur_contracten -> relaties)
--   - Current tenant details (huurder via verhuur_contracten -> relaties)
--   - Rental status and financials
...
-- Access info
h.kluis_code_1, h.kluis_code_2,

-- GWE/Utilities
h.meterbeheerder, h.gwe_leverancier,
...
-- Days until available (for active contracts)
CASE
